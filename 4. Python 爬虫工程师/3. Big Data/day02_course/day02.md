...
6. 将HDFS中 /studir/stuinfo/students.txt 下载到本地命名为 new_students.txt
   ...
   hadoop  fs   -get   /studir/stuinfo/students.txt   /home/tarena/new_students.txt
...
2、把/home/tarena/passwd 文件映射到hive中 tedu 库中的 usertab表
3、字段(7个)
   username
   password
   uid
...
- **答案**
  ...
  【2】导入文件映射
  load data local inpath '/home/tarena/passwd' into table usertab;
  ```
